...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [45, 77, 99, -2, -10, -99999999999]
    threshold = 100
    expected = 0
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    sequence = []
    for k in range(100):
        sequence.append(random.randrange(-42, 43))
    threshold = -42.0000001
    expected = 100
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 4
    actual = count_positive_sines([3, 7, 8, 9, 4])
    print()
